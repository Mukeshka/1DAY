...
<i>Any actions and or activities related to <b>Rxcehack</b> is solely your responsibility. The misuse of this toolkit can result in <b>criminal charges</b> brought against the persons in question. <b>The contributors will not be held responsible</b> in the event any criminal charges be brought against any individuals misusing this toolkit to break the law.
...
- On first launch, It'll install the dependencies and that's it. `Rxcehack` is installed.

### Run on Docker
```
$ docker pull rajja8/Rxcehack
...
### Find Me on :
<p align="left">
  <a href="https://github.com/rajja8" target="_blank"><img src="https://img.shields.io/badge/Github-rajja8-green?style=for-the-badge&logo=github"></a>
